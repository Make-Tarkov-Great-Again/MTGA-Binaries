...
{
    public class LoadBotProfileFromServerPt1Patch : ModulePatch
    {
        public LoadBotProfileFromServerPt1Patch() { }
        ...
        public static bool ActualPatch(object __instance, object data, EFT.Profile __result, List<EFT.Profile> ___list_0)
        {
            ...
            {
                Logger.LogInfo("LoadBotProfileFromServerPt1Patch:ActualPatch:List count: " + ___list_0.Count);
                var firstOriginalProfile = ___list_0[0];
                //Logger.LogInfo($"LoadBotProfileFromServerPt1Patch:Original Profile 0:{firstOriginalProfile.AccountId}:{firstOriginalProfile.Side}:{firstOriginalProfile.Info.Voice}");
                ...
                if (profileObj == null)
                {
                    Logger.LogInfo("LoadBotProfileFromServerPt1Patch:ActualPatch:Profile not found");
                    return false;
                }
                ...
                if (profile != null)
                {
                    ...
                    Logger.LogInfo($"LoadBotProfileFromServerPt1Patch:Profile:{profile.AccountId}:{profile.Side}:{profile.Info.Voice}");
                    ...
                    //Logger.LogInfo("LoadBotProfileFromServerPt1Patch.PatchPrefix: " + resultJson);
            ...
            //Logger.LogInfo("LoadBotProfileFromServerPt1Patch.PatchPrefix: " + profilesInCache.MTGAToJson());
